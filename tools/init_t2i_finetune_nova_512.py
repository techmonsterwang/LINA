...
def load_from_nova(pipe, pretrained_path):
    ...
    output_file = os.path.join(output_dir, "finetune_nova_512.txt")
...
if __name__ == "__main__":
    # fmt: off
    cfg_file = "/share/project/wangjiahao/LAR/diffnext/config/t2i/sdxl28m_nova_d48w1536_512px_finetune_nova.yml"
    # fmt: on
