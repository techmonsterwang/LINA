...
def load_from_nova(pipe, pretrained_path):
    ...
    output_file = os.path.join(output_dir, "finetune_nova_512_v2.txt")
...
if __name__ == "__main__":
    # fmt: off
    cfg_file = "/share/project/wangjiahao/LAR/diffnext/config/t2i/sdxl28m_nova_d48w1536_512px_finetune_nova_v2.yml"
    # fmt: on
    ...
    init_scratch(pipe)
    pretrained_path = "/share/project/wangjiahao/LAR/exp_dir/t2i/linear_decouple1_kvscale1_w1536_6node_finetune_nova/ema_checkpoints/sdxl28m_nova_d48w1536_256px_iter_600000/transformer"
