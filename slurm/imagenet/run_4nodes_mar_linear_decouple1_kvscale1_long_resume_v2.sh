...
--exp-dir "exp_dir/linear_decouple1_kvscale1_long" \
...
2>&1 | tee /share/project/wangjiahao/LAR/logs/train/20250806_run_4node_${rank}_mar_imagenet_linear_decouple1_kvscale1_long_resume_v2.log