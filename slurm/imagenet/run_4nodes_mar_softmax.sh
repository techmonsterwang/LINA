...
--exp-dir "exp_dir/softmax" \
--master-ip job-70ab8b73-3323-4283-981d-3eca451df53e-master-0 \
--cfg /share/project/wangjiahao/LAR/diffnext/config/imagenet/linear/softmax_mar1k_nova_d48w768_256px.yml \
2>&1 | tee /share/project/wangjiahao/LAR/logs/train/20250425_run_4node_${rank}_mar_imagenet_softmax.log