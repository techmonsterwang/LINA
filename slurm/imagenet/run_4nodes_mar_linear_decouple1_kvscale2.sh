...
--exp-dir "exp_dir/linear_decouple1_kvscale2" \
...
2>&1 | tee /share/project/wangjiahao/LAR/logs/train/20250619_run_4node_${rank}_mar_imagenet_linear_decouple1_kvscale2.log