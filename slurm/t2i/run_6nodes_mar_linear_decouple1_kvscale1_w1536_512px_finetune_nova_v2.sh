...
--exp-dir "exp_dir/t2i/linear_decouple1_kvscale1_w1536_6node_finetune_nova_512px_v2" \
...
2>&1 | tee /share/project/wangjiahao/LAR/logs/train/20250930_run_6node_${rank}_mar_t2i_linear_decouple1_kvscale1_w1536_512px_finetune_nova_v2.log