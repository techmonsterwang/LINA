...
--exp-dir "exp_dir/t2i/linear_decouple1_kvscale1_w1536" \
...
2>&1 | tee /share/project/wangjiahao/LAR/logs/train/20250812_run_4node_${rank}_mar_t2i_linear_decouple1_kvscale1_w1536_256px.log