...
from diffnext.models.transformers.transformer_3d_disa import Transformer3DModel
from diffnext.models.vision_transformer_linear_decouple1 import VisionTransformer
...
@IMAGE_ENCODERS.register("vit_d32w768", depth=32, embed_dim=768, num_heads=12, image_model=True)
@IMAGE_ENCODERS.register("vit_d32w1024", depth=32, embed_dim=1024, num_heads=16, image_model=True)
@IMAGE_ENCODERS.register("vit_d32w1536", depth=32, embed_dim=1536, num_heads=16, image_model=True)
def image_encoder(depth, embed_dim, num_heads, patch_size, image_size, image_dim, image_model=False):
    return VisionTransformer(**locals())
