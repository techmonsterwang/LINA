...
##############################################################################
"""Simple implementation of AutoEncoderKL for MAR."""
...
class UNetResBlock(nn.Module):
    ...
    def __init__(self, dim, out_dim, depth=2, downsample=0, upsample=0):
        ...
        self.attentions = nn.ModuleList()  # Legacy AttnResBlock.
...
class Encoder(nn.Module):
    ...
    def __init__(self, dim, out_dim, block_dims, block_depth=2, double_z=True):
...
class AutoencoderKLMAR(ModelMixin, ConfigMixin):
    """AutoEncoder KL."""
    ...
    def __init__(
        ...
        super(AutoencoderKLMAR, self).__init__()
        ...
        extra_attentions = [Attention(block_out_channels[-1]) for _ in range(layers_per_block)]
        self.encoder.down_blocks[-1].attentions += extra_attentions
