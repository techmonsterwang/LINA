...
def main():
    ...
    print('******* Directly reading NPY files, skipping calculations, saving time ******* ')
    ref_acts_1 = np.load('/share/project/denghaoge/Autoregressive/Dataset/openai_ref_acts_1.npy')
    ref_acts_2 = np.load('/share/project/denghaoge/Autoregressive/Dataset/openai_ref_acts_2.npy')
    ref_acts = (ref_acts_1, ref_acts_2)
