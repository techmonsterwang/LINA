...
torchrun --nproc_per_node 4 sample.py \
  ...
  --outdir ${BASELINE_ROOT}/sample_image/vae_mar_1k_w768_256px/250k_256px_ar64_cfg3.3 \
  2>&1 | tee /share/project/wangjiahao/visual_evaluation/fid50k/logs/sample/250k_256px_ar64_cfg3.3.log
