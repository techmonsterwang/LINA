...
torchrun --nproc_per_node 4 sample_bf16.py \
  ...
  --outdir ${BASELINE_ROOT}/sample_image/linear_decouple1_kvscale1/vae_mar_1k_w1536_256px/1200k_256px_ar64_cfg1.0 \
  2>&1 | tee /share/project/wangjiahao/visual_evaluation/fid50k/logs/linear_decouple1_kvscale1/sample_w1536/1200k_256px_ar64_cfg1.0.log
