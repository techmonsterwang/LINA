...
torchrun --nproc_per_node 4 sample.py \
  ...
  --num_pred_steps 64 --guidance_scale 2.52 --prompt_size 25 --distributed \
  --outdir ${BASELINE_ROOT}/sample_image/vae_mar_1k_w768_256px/400k_256px_ar64_cfg2.52 \
  2>&1 | tee /share/project/wangjiahao/visual_evaluation/fid50k/logs/sample/400k_256px_ar64_cfg2.52.log
