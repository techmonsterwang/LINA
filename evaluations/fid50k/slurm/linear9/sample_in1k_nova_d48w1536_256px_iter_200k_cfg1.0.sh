...
torchrun --nproc_per_node 4 sample_bf16.py \
  ...
  --ckpt /share/project/wangjiahao/LAR/exp_dir/linear9_w1536/ema_checkpoints/in1k_nova_d48w1536_256px_iter_200000 \
  --num_pred_steps 64 --guidance_scale 1.0 --prompt_size 25 --distributed \
  --outdir ${BASELINE_ROOT}/sample_image/linear9/vae_mar_1k_w1536_256px/200k_256px_ar64_cfg1.0 \
  2>&1 | tee /share/project/wangjiahao/visual_evaluation/fid50k/logs/linear9/sample_w1536/200k_256px_ar64_cfg1.0.log
