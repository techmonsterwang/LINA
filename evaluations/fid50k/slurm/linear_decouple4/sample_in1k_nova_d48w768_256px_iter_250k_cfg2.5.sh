...
torchrun --nproc_per_node 4 sample_bf16.py \
  ...
  --ckpt /share/project/wangjiahao/LAR/exp_dir/linear_decouple4/ema_checkpoints/in1k_nova_d48w768_256px_iter_250000 \
  --num_pred_steps 64 --guidance_scale 2.5 --prompt_size 25 --distributed \
  --outdir ${BASELINE_ROOT}/sample_image/linear_decouple4/vae_mar_1k_w768_256px/250k_256px_ar64_cfg2.5 \
  2>&1 | tee /share/project/wangjiahao/visual_evaluation/fid50k/logs/linear_decouple4/sample/250k_256px_ar64_cfg2.5.log
